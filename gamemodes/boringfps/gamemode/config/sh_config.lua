...
local timerForVote = CreateConVar("bfps_timer_for_vote", "20", { FCVAR_SERVER_CAN_EXECUTE, FCVAR_REPLICATED, FCVAR_ARCHIVE }, "Define how much time players have to vote for next map", 1)
