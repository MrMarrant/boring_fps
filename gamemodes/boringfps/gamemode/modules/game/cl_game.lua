function BoringFPS.DisplayHUDTurn()
    ...
    hook.Add( "HUDPaint", "HUDPaint:BoringFPS:HUDTurn", function()
        draw.DrawText( "Time left : " .. math.Round(startTime - CurTime()) + 1, "TargetID", BoringFPS_CONFIG.Vars.ScrW * 0.9, BoringFPS_CONFIG.Vars.ScrH * 0.9, Color(184, 0, 0), TEXT_ALIGN_CENTER )
        draw.DrawText( "Step left : " .. ply:GetNWInt("StepLeft"), "TargetID", BoringFPS_CONFIG.Vars.ScrW * 0.9, BoringFPS_CONFIG.Vars.ScrH * 0.95, Color(28, 0, 184), TEXT_ALIGN_CENTER )
    end )
end
